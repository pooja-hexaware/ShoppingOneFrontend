...
import { deleteOrderItem, fetchOrderItem } from './store/OrderItem.action'
...
const OrderItemList = () => {
    ...
    const { entities } = useSelector((state) => state.OrderItem)
