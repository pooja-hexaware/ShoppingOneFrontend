...
import { deleteReview, fetchReview } from './store/Review.action'
...
const ReviewList = () => {
    ...
    const { entities } = useSelector((state) => state.Review)
    ...
    const columns = [
        { field: 'reviewNumber', headerName: 'ReviewNumber', width: 200 },
